...
echo %line%
echo.
echo. 1. 安装Office2024全部
if %_O2019%==1 echo. 2. 安装Office 2019 单软件
if %_O2021%==1 echo. 3. 安装Office 2021 单软件
:: if %_O2024%==1 echo. 4. 安装Office2024单软件
echo.
echo %line%
choice /c 123X /n /m "选择一个选项 "
...
echo. 1. 微软 365 企业版 : %_O365PP%
echo. 2. Office Mondo 2016        : %_Mondo%
if %_O2021%==1 (
echo.
echo. 3. Office 专业增强版 2021      : %_O21Pro%
echo. 4. Office 普通版 2021     : %_O21Std%
)
if %_O2021%==1 if %_supv%==1 (
echo. 5. Project 专业版2021         : %_O21PrjPro%
echo. 6. Project 普通版 2021    : %_O21PrjStd%
echo. 7. Visio 专业版2021           : %_O21VisPro%
echo. 8. Visio 普通版 2021      : %_O21VisStd%
)
if %_O2019%==1 (
echo.
echo. F. Office 专业增强版 2019      : %_O19Pro%
echo. D. Office 普通版 2019     : %_O19Std%
)
if %_O2019%==1 if %_supv%==1 (
echo. P. Project 专业版2019         : %_O19PrjPro%
echo. R. Project 普通版 2019    : %_O19PrjStd%
echo. V. Visio 专业版2019           : %_O19VisPro%
echo. S. Visio 普通版 2019      : %_O19VisStd%
)
if %_O2024%==1 (
echo.
echo. G. Office 专业增强版 2024      : %_O24Pro%
)
if %_O2024%==1 if %_supv%==1 (
echo. W. Project 专业版2024         : %_O24PrjPro%
echo. Y. Visio 专业版2024           : %_O24VisPro%
)



echo %line%
choice /c 123456789FDPRVSGWY0X /n /m "按下你需要的组件的字母设置开启，按9返回，X退出，0确认 "
set errortmp=%errorlevel%
...
echo %line%
choice /c AENOPRSWD567890TX /n /m "按下你需要的组件的字母设置开启，按9返回，X退出，0确认 "
set errortmp=%errorlevel%
...
if not %_Teams%==0 echo. T. Microsoft Teams  : %_Teams%
echo %line%
choice /c AENOPRSWJVD90TX /n /m "按下你需要的组件的字母设置开启，按9返回，X退出，0确认 "
...
echo. 2. Current / 月频道预览           ^|   Insiders::CC
echo. 3. Current / 月频道                   ^| Production::CC
echo.
echo. 4. 企业版月                  ^| Production::MEC
...
echo %line%
choice /c 1234567809X /n /m "按下你需要的组件的字母设置开启，按9返回，X退出 "
...
echo %line%
choice /c 123456709X /n /m "按下你需要的组件的字母设置开启，按9返回，X退出，0确认 "
